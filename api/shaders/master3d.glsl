...
vec3 generateNormal(vec3 z, float d)
{
    ...
    float dx1 = Fractal(z + vec3(e, 0, 0)).x;
    float dx2 = Fractal(z - vec3(e, 0, 0)).x;

    float dy1 = Fractal(z + vec3(0, e, 0)).x;
    float dy2 = Fractal(z - vec3(0, e, 0)).x;

    float dz1 = Fractal(z + vec3(0, 0, e)).x;
    float dz2 = Fractal(z - vec3(0, 0, e)).x;
