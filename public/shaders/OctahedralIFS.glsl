...
vec3 generateNormal(vec3 z, float d)
{
    ...
    float dx1 = OctahedralIFS(z + vec3(e, 0, 0)).x;
    float dx2 = OctahedralIFS(z - vec3(e, 0, 0)).x;

    float dy1 = OctahedralIFS(z + vec3(0, e, 0)).x;
    float dy2 = OctahedralIFS(z - vec3(0, e, 0)).x;

    float dz1 = OctahedralIFS(z + vec3(0, 0, e)).x;
    float dz2 = OctahedralIFS(z - vec3(0, 0, e)).x;
