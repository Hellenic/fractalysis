...
vec3 generateNormal(vec3 z, float d)
{
    ...
    float dx1 = SphereSponge(z + vec3(e, 0, 0)).x;
    float dx2 = SphereSponge(z - vec3(e, 0, 0)).x;

    float dy1 = SphereSponge(z + vec3(0, e, 0)).x;
    float dy2 = SphereSponge(z - vec3(0, e, 0)).x;

    float dz1 = SphereSponge(z + vec3(0, 0, e)).x;
    float dz2 = SphereSponge(z - vec3(0, 0, e)).x;
